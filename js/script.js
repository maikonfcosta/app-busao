...
const CARD_DB = [
  ...
  P({id:"leandro",nome:"Leandro (O Dorminhoco)",base:3,faixa:"Adulto",temper:"Equilibrado",comp:"Silencioso",
     ...
     ability:(_p,ctx,log)=>{ const n=ctx.countBus(c=>!c.isCobrador && c.comp==="Silencioso"); if(n){log(`+${n} por Silencioso no busão`);} return n; }
  }),
  P({id:"sol",nome:"Sol (Good Vibes)",base:2,faixa:"Jovem",temper:"Tranquilo",comp:"Silencioso",
     ...
     ability:(_p,ctx,log)=>{ const e=ctx.countBus(c=>!c.isCobrador && c.temper==="Equilibrado"); const cm=ctx.countBus(c=>!c.isCobrador && c.comp==="Comunicativo");
  ...
  P({id:"rato",nome:"Rato (O Malandro)",base:1,faixa:"Jovem",temper:"Caótico",comp:"Barulhento",
     ...
     ability:(_p,ctx,log)=>{ const n=ctx.countBus(c=>!c.isCobrador && c.faixa==="Idoso"); if(n){log(`+${2*n} (+2 por ${n} Idoso no busão)`);} return 2*n; }
  }),
  ...
  P({id:"cleber",nome:"Cléber (O Vendedor)",base:3,faixa:"Adulto",temper:"Caótico",comp:"Barulhento",impacto:"durante",
  ...
  P({id:"feitosa",nome:"Feitosa (O Policial)",base:2,faixa:"Adulto",temper:"Caótico",comp:"Comunicativo",impacto:"durante-final",
     ...
     ability:(_p,ctx,log)=>{ const n=ctx.countBus(c=>!c.isCobrador && c.temper==="Tranquilo"); if(n){log(`+${n} por Tranquilo no busão`);} return n; },
  ...
  P({id:"marcia_enzo",nome:"Márcia e Enzo (Mãe e Pestinha)",base:2,faixa:"Adulto",temper:"Equilibrado",comp:"Barulhento",
     ...
     penalty:(_p,ctx,log)=>{ const n=ctx.countBus(c=>!c.isCobrador && c.comp==="Silencioso"); if(n){log(`-${2*n} ( -2 por ${n} Silencioso no busão )`);} return -2*n; }
  }),
  ...
  P({id:"claudio",nome:"Cláudio (O Pastor)",base:2,faixa:"Adulto",temper:"Caótico",comp:"Barulhento",impacto:"durante",
     ...
     penalty:(_p,ctx,log)=>{ const n=ctx.countBus(c=>!c.isCobrador && c.comp==="Silencioso"); if(n){log(`-${n} ( -1 por ${n} Silencioso no busão )`);} return -n; },
  ...
  P({id:"misterioso",nome:"O Misterioso",base:4,faixa:"Adulto",temper:"Tranquilo",comp:"Silencioso",
     ...
     require:(ctx,p)=> ({ok: p.col===5, msg:"Sô embarca no fundo do busão (coluna 6)."})
  }),
  ...
  P({id:"costelinha",nome:"Costelinha (O Caramelo)",base:1,faixa:"?",temper:"?",comp:"?",
     ...
     ability:(_p,ctx,log)=>{ const n=ctx.countBus(c=>!c.isCobrador); if(n){log(`+${n} por ${n} passageiro(s) no busão`);} return n; }
  }),
...
const COBRADORES = [
  P({id:"cob_marlene",nome:"Marlene (O Anjo da Terceira idade) [Cobrador]",isCobrador:true,base:0,
     ...
     ability:(_p,ctx,log)=>{const n=ctx.countBus(c=>!c.isCobrador && c.faixa==="Idoso"); if(n){log(`+${2*n} (+2 por ${n} Idoso)`);} return 2*n;}
  }),
  P({id:"cob_ze",nome:"Zé (O Tiozão) [Cobrador]",isCobrador:true,base:0,
     text:"+2 pontos para cada Adulto",
     ability:(_p,ctx,log)=>{const n=ctx.countBus(c=>!c.isCobrador && c.faixa==="Adulto"); if(n){log(`+${2*n} (+2 por ${n} Adulto)`);} return 2*n;}
  }),
  P({id:"cob_brenda",nome:"Brenda (A Jovenzona) [Cobrador]",isCobrador:true,base:0,
     text:"+2 pontos para cada Jovem",
     ability:(_p,ctx,log)=>{const n=ctx.countBus(c=>!c.isCobrador && c.faixa==="Jovem"); if(n){log(`+${2*n} (+2 por ${n} Jovem)`);} return 2*n;}
  }),
  P({id:"cob_angelina",nome:"Angelina (A tranquilidade em pessoa) [Cobrador]",isCobrador:true,base:0,
     ...
     ability:(_p,ctx,log)=>{const n=ctx.countBus(c=>!c.isCobrador && c.temper==="Tranquilo"); if(n){log(`+${2*n} (+2 por ${n} Tranquilo)`);} return 2*n;}
  }),
  P({id:"cob_saulo",nome:"Saulo (O Indiferente) [Cobrador]",isCobrador:true,base:0,
     text:"+2 pontos para cada Equilibrado",
     ability:(_p,ctx,log)=>{const n=ctx.countBus(c=>!c.isCobrador && c.temper==="Equilibrado"); if(n){log(`+${2*n} (+2 por ${n} Equilibrado)`);} return 2*n;}
  }),
  P({id:"cob_leozinho",nome:"Léozinho (O Causador) [Cobrador]",isCobrador:true,base:0,
     text:"+2 pontos para cada Caótico",
     ability:(_p,ctx,log)=>{const n=ctx.countBus(c=>!c.isCobrador && c.temper==="Caótico"); if(n){log(`+${2*n} (+2 por ${n} Caótico)`);} return 2*n;}
  }),
  P({id:"cob_padilha",nome:"Padilha (O Cansado) [Cobrador]",isCobrador:true,base:0,
     text:"+2 pontos para cada Silencioso",
     ability:(_p,ctx,log)=>{const n=ctx.countBus(c=>!c.isCobrador && c.comp==="Silencioso"); if(n){log(`+${2*n} (+2 por ${n} Silencioso)`);} return 2*n;}
  }),
  P({id:"cob_camila",nome:"Camila (A Conversadeira) [Cobrador]",isCobrador:true,base:0,
     text:"+2 pontos para cada Comunicativo",
     ability:(_p,ctx,log)=>{const n=ctx.countBus(c=>!c.isCobrador && c.comp==="Comunicativo"); if(n){log(`+${2*n} (+2 por ${n} Comunicativo)`);} return 2*n;}
  }),
  P({id:"cob_gilmar",nome:"Gilmar (O Escandaloso) [Cobrador]",isCobrador:true,base:0,
     text:"+2 pontos para cada Barulhento",
     ability:(_p,ctx,log)=>{const n=ctx.countBus(c=>!c.isCobrador && c.comp==="Barulhento"); if(n){log(`+${2*n} (+2 por ${n} Barulhento)`);} return 2*n;}
  }),
];
...
const APAIXONADOS = [
  ...
  P({id:"apa_jessica",nome:"Jéssica (A Apaixonada)", base:4, faixa:"Jovem", temper:"Equilibrado", comp:"Barulhento",
     ...
     scoreReq:(ctx,_p)=> ({ok: ctx.countBus(c=>c.isApaixonado)>1, msg:"Precisa estar com outro apaixonado no busão para pontuar."})
  }),
];
...
const ESTOU_NO_BUSAO = [
  ...
  P({id:"ursinha",nome:"Ursinha (A Furiosa)",base:0,faixa:"?",temper:"?",comp:"?",
     penalty:(_p,ctx,log)=>{ const n=ctx.countBus(c=>!c.isCobrador); if(n){log(`-${n} ( -1 por ${n} passageiro(s) no busão )`);} return -n; },
  ...
  P({id:"edio",nome:"Édio (O Músico)",base:1,faixa:"Adulto",temper:"Tranquilo",comp:"Barulhento",
     text:"Se ele e 'A Artesã' estiverem no mesmo busão, as cartas que sobrarem na sua mão valem pontos positivos.",
     note:"Se ele e 'A Artesã' estiverem no mesmo busão, as cartas que sobrarem na sua mão valem pontos positivos."
  }),
  ...
  P({id:"lucas",nome:"Lucas (O Mario do Carnaval)",base:6,faixa:"Adulto",temper:"Equilibrado",comp:"Comunicativo",
     text:"Sô pontua se estiver adjacente ao passageiro 'Luigi do Carnaval'.",
  ...
  P({id:"guilherme",nome:"Guilherme (O Luigi do Carnaval)",base:6,faixa:"Adulto",temper:"Equilibrado",comp:"Comunicativo",
     text:"Sô pontua se estiver adjacente ao passageiro 'Mario do Carnaval'.",
     scoreReq:(ctx,p)=> ({ok: ctx.countAdj(p,c=>c.id==="lucas")>0, msg:"Precisa estar adjacente a 'Lucas (O Mario do Carnaval)' para pontuar."})
  }),
  P({id:"nelson",nome:"Nelson (O Nerd Velho)",base:6,faixa:"Adulto",temper:"Tranquilo",comp:"Silencioso",
     text:"Sô pontua se estiver sozinho na coluna que ocupa.",
     scoreReq:(ctx,p)=> {
       const other = p.row===0 ? ctx.getPos(1,p.col) : ctx.getPos(0,p.col);
       const ok = !other.card;
...
const LENDAS_URBANAS = [
  P({id:"paula",nome:"Paula (A Loira do Banheiro)",base:1,faixa:"Adulto",temper:"Caótico",comp:"Comunicativo",
     text:"-7 pontos se não tiver a melhoria Banheiro no Busão.",
     penalty:(_p,ctx,log)=> {
